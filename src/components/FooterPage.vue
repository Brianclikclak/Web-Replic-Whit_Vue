<script setup>
import IconoTwitter from './icons/IconoTwitter.vue';
import IconoFacebook from './icons/IconoFacebook.vue';
import IconoPinterest from './icons/IconoPinterest.vue';
import IconoInsta from './icons/IconoInsta.vue';
</script>
...
<template>
    <footer>
        ...
        <div class="footer-div">
            <div class="div-icons">
            <ul>
            <li class="iconos-redes"><IconoTwitter/></li>  
            <li class="iconos-redes"><IconoFacebook/></li>
            <li class="iconos-redes"><IconoPinterest/></li>
            <li class="iconos-redes"><IconoInsta/></li>
            </ul>
            </div>
        </div>
    </section>
